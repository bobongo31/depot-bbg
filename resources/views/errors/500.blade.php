...
@section('content')
    <div class="flex items-center justify-center min-h-screen bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
        <div class="text-center p-6 bg-white rounded-lg shadow-lg max-w-lg w-full">
            ...
            <div class="text-8xl text-red-600">
                <i class="fas fa-exclamation-triangle"></i>
            </div>
            
            <h1 class="text-5xl font-bold text-gray-900 mt-4">500</h1>
            <p class="mt-4 text-lg text-gray-700">Une erreur est survenue sur le serveur. Veuillez réessayer plus tard.</p>
