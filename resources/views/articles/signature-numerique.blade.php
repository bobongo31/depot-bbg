...
@section('meta')
    ...
    <meta property="og:image" img src="https://172.233.244.133.nip.io/image/Signature-Numerique.jpg">
    <!-- Open Graph / Facebook -->
    ...
    <meta name="twitter:image" img src="https://172.233.244.133.nip.io/image/Signature-Numerique.jpg">
...
<section style="background: linear-gradient(135deg, rgb(19, 28, 37), rgb(10, 42, 68)); padding: 60px 20px;">
    <div class="container text-white">
        ...
        <p class="mb-5" style="font-size: 18px;">Signez vos documents en ligne de façon sécurisée avec la signature électronique conforme aux normes légales. Fini les impressions inutiles !</p>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-12">
                <div class="bg-dark text-white p-5 rounded shadow-lg">
                    ...
                    <a href="inscription" class="btn btn-primary mt-3">Activer la signature</a>
                </div>
            </div>
        </div>
    </div>
