...
@section('meta')
    ...
    <meta name="description" content="Découvrez en détail nos services : transformation digitale, gestion documentaire, communication numérique, création de sites internet, et plus.">
    <meta name="keywords" content="Services informatiques, transformation digitale, automatisation, gestion documentaire, création de sites internet, entreprise Kinshasa, IT, communication numérique">
...
@php
    $services = [
        ...
        [
            ...
            'desc' => 'Nous concevons des sites web modernes, responsive, adaptés à votre image et aux besoins spécifiques de votre activité.',
            'items' => [
                'Conception sur mesure',
                'Sites optimisés SEO',
                'Intégration e-commerce'
            ],
            'gradient' => 'linear-gradient(135deg, #3e5d74, #4a6e87)'
        ]
    ];
@endphp

@foreach($services as $index => $service)
<section class="rounded-3" style="background: {{ $service['gradient'] }}; padding: 80px 20px 80px 20px;" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
    <div class="container text-white text-center scroll-animated">
...
@section('scripts')
<script>
    // Appliquer la classe "visible" pour activer l'animation au scroll
