...
<div class="scroll-animated container my-5">
    ...
    @if(isset($reponse))
        <div class="scroll-animated card p-4 bg-white mb-4">
            <h2 class="mb-3">
                <i class="fas fa-info-circle me-2 text-secondary"></i>Détails de la Réponse
            </h2>

            {{-- ===== STATUT DU COURRIER (SÉCURISÉ) ===== --}}
            @php
        ...
        <h3 class="scroll-animated mb-3">
            <i class="fas fa-paperclip me-2"></i>Annexes de la Réponse
        </h3>
        ...
        <div class="scroll-animated card p-3 bg-light">
                ...
                <ul class="list-group list-group-flush">
                    @foreach ($reponse->annexes as $annexe)
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ asset('storage/' . $annexe->file_path) }}"
            ...
            @else
                <p class="scroll-animated text-muted mb-0">
                    Aucune annexe pour cette réponse
                </p>
            @endif
        </div>
    @else
        <p class="scroll-animated text-danger mt-4">
    ...
    @if(isset($reponse) && $reponse->reponseFinale)
        <h3 class="scroll-animated mt-5 mb-3">
            <i class="fas fa-check-circle text-success me-2"></i>Réponse Finale
        </h3>
    ...
    @else
        <p class="scroll-animated text-muted mt-4">
    ...
    <a href="{{ route('reponses.index') }}"
       class="btn btn-outline-secondary mt-4 scroll-animated">
