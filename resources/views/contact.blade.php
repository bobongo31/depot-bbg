...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <!-- Titre -->
        <div class="scroll-animated section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
        ...
        <div class="row g-5 mb-5">
            <!-- Téléphone -->
            <div class="scroll-animated col-lg-4">
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                <form method="POST" action="{{ route('contact.send') }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="scroll-animated col-12">
            ...
            <!-- Carte Google Maps -->
            <div class="scroll-animated col-lg-6 wow slideInUp" data-wow-delay="0.6s">
                <iframe 
