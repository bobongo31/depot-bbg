                ...
                <div class="row gx-5">
                    <div class="col-lg-8 col-md-12 pt-5 mb-5">
                        ...
                        <div class="scroll-animated d-flex mt-4">
                            ...
                            <a class="btn btn btn-square" href="#" style="background-color: #0b0557; color: #fff;">
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="scroll-animated link-animated d-flex flex-column justify-content-start">
                            ...
                            <a class="text-light" href="/foire-questions"><i class="fas fa-arrow-right text me-2" style="color:rgb(255, 255, 255);"></i>FAQ</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Back to Top
    <a href="#" class="btn btn-lg btn btn-lg-square rounded back-to-top" style="color:#3cc994;">
